...
char		**create_new_map(char **map, int row, char *line,
				t_game_data *data);
...
void		error_parsing(char *message, char **array, char *line,
				t_game_data *data);
void		check_extension(char *file, char *line, t_game_data *data,
				char *ext);
